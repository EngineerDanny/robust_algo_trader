...
dataset_dict = {
    "EURUSD_H1_2011_2015_TRADES_real" : f"{root_data_dir}/EURUSD_H1_2011_2015_TRADES_real.csv",
    "EURUSD_H1_2011_2015_TRADES_synthetic" : f"{root_data_dir}/EURUSD_H1_2011_2015_TRADES_synthetic.csv",
}
...
classifier_dict = {
    ...
    "MLPClassifier" : GridSearchCV(MLPClassifier(),
                                    param_grid={'hidden_layer_sizes': [(50,50,50), (50,100,50), (100,), (200, 100, 50), (300, 200, 100, 50), (400, 300, 200, 100), (500, 400, 300, 200)],
...
if "index" in dataset_pd.columns:
    dataset_pd = dataset_pd.drop(columns=["index"])

input_mat, output_vec = dataset_pd.iloc[:, :-1].values, dataset_pd.iloc[:, -1].values
